...
# Morpho-Aave V2 optimizer supplier position update
cryo logs \
    --label ma2_supplier_update \
    --subdirs datatype \
    --blocks 15M: \
    --contract 0x777777c9898d384f785ee44acfe945efdff5f3e0 \
    --event-signature "SupplierPositionUpdated(address indexed _user, address indexed _poolToken,uint256 _balanceOnPool,uint256 _balanceInP2P)" \
    --inner-request-size 1000\
...
# Morpho-Aave V2 optimizer borrower position update
cryo logs \
    --label ma2_borrower_update \
    --subdirs datatype \
    --blocks 15M: \
    --contract 0x777777c9898d384f785ee44acfe945efdff5f3e0 \
    --event-signature "BorrowerPositionUpdated(address indexed _user, address indexed _poolToken,uint256 _balanceOnPool,uint256 _balanceInP2P)" \
    --inner-request-size 1000\
    --topic0 0x0aec3812ec00f2d2f0eacc89fd13923091a68f30c3b3d0336e364544322b9758

# Morpho-Aave V2 optimizer rate updates
cryo logs \
    --label ma2_rates \
    --subdirs datatype \
    --blocks 15M: \
    --contract 0x777777c9898d384f785ee44acfe945efdff5f3e0 \
    --event-signature "P2PIndexesUpdated(address indexed _poolToken,uint256 _p2pSupplyIndex,uint256 _p2pBorrowIndex,uint256 _poolSupplyIndex,uint256 _poolBorrowIndex)" \
    --inner-request-size 1000\
    --topic0 0xe9f571cc89dec9d3545848be792adb166a35fd4ac7f853471f9b5a16db51b9e8


# Morpho-Aave V2 optimizer liquidation
cryo logs \
    --label ma2_liquidation \
    --subdirs datatype \
    --blocks 15M: \
    --contract 0x777777c9898d384f785ee44acfe945efdff5f3e0 \
